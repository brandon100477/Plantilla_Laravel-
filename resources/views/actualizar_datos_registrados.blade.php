...
<body>
    ...
    <section class="inicio">
        ...
        <a href="sedes.php" class="volver">Volver</a>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <input type="text" id="nombre" name="nombre" placeholder="<?php echo $row->nombre; ?>"
                            class="input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="telefono" name="telefono" placeholder="<?php echo $row->telefono; ?>"
                            class="input">
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <input type="text" id="especialidad" name="especialidad"
                            placeholder="<?php echo $row->especialidad; ?>" class="input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="direccion" name="direccion" placeholder="<?php echo $row->direccion; ?>"
                            class="input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ciudad" name="ciudad" placeholder="<?php echo $row->ciudad; ?>"
                            class="input">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <input type="text" id="secretaria" name="secretaria" placeholder="<?php echo $row->secretaria; ?>"
                            class="input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ips_consulta" name="ips_consulta"
                            placeholder="<?php echo $row->ips_consulta; ?>" class="input">
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <input type="text" id="tel_ayuda" name="tel_ayuda" placeholder="<?php echo $row->tel_ayuda; ?>"
                            class="input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ips_cirugia" name="ips_cirugia"
                            placeholder="<?php echo $row->ips_cirugia; ?>" class="input">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag1; ?>" name="preg_indag1" for="nombre"
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag3; ?>" name="preg_indag2" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag2; ?>" name="preg_indag3" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag4; ?>" name="preg_indag4" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag5; ?>" name="preg_indag5" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="email">15. ¿Cuantos procedimientos de apoyo diagnóstico ordena en el mes? <br> Más de 5
                            más de 10</label>
                        <textarea placeholder="<?php echo $row->preg_indag7; ?>" name="preg_indag6" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        <label for="nombre">16. ¿Sabe usar nuestra plataforma, para ver los resultados e imágenes <br> de
                            sus pacientes?</label>
                        <textarea placeholder="<?php echo $row->preg_indag6; ?>" name="preg_indag7" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="form-group">
                        <label for="nombre">17. ¿Que cosas positivas ha encontrado en el proceso de toma <br> de
                            imagenes?</label>
                        <textarea placeholder="<?php echo $row->preg_indag8; ?>" name="preg_indag8" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag10; ?>" name="preg_indag9" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag9; ?>" name="preg_indag10" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="<?php echo $row->preg_indag11; ?>" name="preg_indag11" for="nombre"
                            style="resize: none;" class="c_preg1" rows="1" cols="50"></textarea>
                    </div>
                </div>
            </div>
